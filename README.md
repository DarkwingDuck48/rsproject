...
| **Автоматическое перепланирование** | Даты задач не пересчитываются при изменении зависимостей: критический путь считается по уже заданным датам     |
...
- Кнопка «Рассчитать критический путь»; результат сохраняется в состоянии приложения
